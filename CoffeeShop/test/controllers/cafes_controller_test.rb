...
class CafesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cafe" do
    assert_difference('Cafe.count') do
      post cafes_url, params: { cafe: { cost: @cafe.cost, image: @cafe.image, name: @cafe.name } }
    end
  ...
  test "should update cafe" do
    patch cafe_url(@cafe), params: { cafe: { cost: @cafe.cost, image: @cafe.image, name: @cafe.name } }
